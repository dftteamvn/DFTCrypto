...
const char     CRYPTONOTE_NAME[]                             = "UXD";//Named the new name for crytocurrency@DFT
...
const int      P2P_DEFAULT_PORT                              = 16327 ;//DFT Port for P2P Network
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 17327;
